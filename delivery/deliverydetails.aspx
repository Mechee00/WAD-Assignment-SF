<%@ Page Title="SAFOD | Delivery Details" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="deliverydetails.aspx.cs" Inherits="WAD_Assignment_SF.delivery.ConfirmDelivery" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row bg align-items-center ps-5" style="height:500px;">
        ...
        <div class="row">
            ...
            &nbsp;
            <asp:Button ID="confirmbtn" class="col-4 btn mx-2 font-bold text-l py-2 mx-2 btn-success" runat="server" Text="Confirm Delivery" OnClientClick='return confirm("Confirm delivery completed?")' OnClick="confirmbtn_Click" />
            &nbsp;
