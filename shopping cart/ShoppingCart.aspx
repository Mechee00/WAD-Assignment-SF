...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        body{
            background-image:linear-gradient(180deg, rgba(255, 255, 0, 0.1) 0%, rgba(0, 0, 0, .1) 100%), url("../src/img/product_bg1.jpg");
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="margin:auto; width:85%; background-color:white">
        <table style="width:100%">
            <tr>
                <td id="ShoppingCartTitle" class="ContentHeader" style="padding:1%">
                    <h1>Shopping Cart</h1>
                </td>
        ...
        <div class="row justify-content-center mx-auto" style="height:50px">
            ...
            <div class="col-4 btn btn-group" style="padding: 0!important;">
                <asp:Button ID="btnRemove" runat="server" class="btn mx-1 font-bold text-l py-2 btn-warning col" Text="Remove" />
