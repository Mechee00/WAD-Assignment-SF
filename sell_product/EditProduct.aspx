<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="EditProduct.aspx.cs" Inherits="WAD_Assignment_SF.sell_product.EditProduct" %>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td class="auto-style6" rowspan="2">
                    <asp:Button ID="btnBack" runat="server" class="btn font-bold text-l btn-danger my-5" Text="Back" Width="200px" Height="50px" 
            ...
            <tr>
                ...
                <td class="auto-style7">
                    ...
                    <strong style="color:black"> <span class="text-l">*[Product ID] not allow to edit*</span></strong>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="auto-style6" rowspan="3">
                    <asp:Button ID="btnReset" runat="server" class="btn font-bold text-l btn-warning my-5" Text="Reset" Width="200px" Height="50px" CausesValidation="False" OnClick="btnReset_Click" />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="auto-style6" rowspan="3">
                    <asp:Button ID="btnEdit" runat="server" class="btn font-bold text-l btn-success my-5" Text="Edit"  Width="200px" Height="50px" OnClick="btnEdit_Click1"  />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="text-l"><strong>RM</strong>
                    <asp:TextBox ID="txtProductPrice" runat="server" placeholder="E.g. 2.50"></asp:TextBox>
                    <strong style="color:red"> 
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtProductPrice" 
                            ValidationExpression="^\d*\.?\d{2}" ErrorMessage="Invalid input must be in Two Decimal Value" Display="Dynamic" 
                            style="font-size: large"></asp:RegularExpressionValidator>
                    </strong>
                </td>
