        ...
        <div class="inner_container mx-auto">
            <div class="row align-items-center me-5">
                ...
                <div class="row justify-content-center">
                    ...
                    <asp:Button class="col-2 m-3 font-bold text-xl btn btn-outline-primary" ID="btnTran" runat="server" Text="Transactions" Height="60px" CausesValidation="False" OnClick="btnTran_Click" />
