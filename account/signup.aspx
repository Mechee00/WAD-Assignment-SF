        ...
        <div class="inner_container mx-auto">
            <div class="row align-items-center me-5">
                ...
                <div class="row justify-content-center">
                    <asp:Button class="col-3 m-3 font-bold text-xl btn btn-primary" ID="btnSignup" runat="server" ValidationGroup="updateProfile" Text="Update" Height="60px" />
                    <asp:Button class="col-2 m-3 font-bold text-xl btn btn-danger" ID="btnCancel" runat="server" Text="Delete Account" Height="60px" CausesValidation="False" />
                </div>
            </div>
            <div class="row spacer"></div>
        </div>
