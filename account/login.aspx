...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row bg justify-content-start ps-5">
        <!-- Right Login -->
            ...
            <asp:Login ID="Login1" runat="server">
                <LayoutTemplate>
                    ...
                    <div class="row p-1 btn-group-horizontal">
                        ...
                        <asp:Button class="col-4 btn mx-1 font-bold text-l py-2 mx-2 btn-outline-success" ID="btnSignup" runat="server" CommandName="Signup" Text="Sign Up" ValidationGroup="Signup1" />
                    </div>
                </LayoutTemplate>
            </asp:Login>
        </div>
